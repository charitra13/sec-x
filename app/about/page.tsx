    ...
    <main className="relative pt-16">
      <div className="w-full min-h-screen max-w-7xl mx-auto px-8 py-24 relative z-10">
        <div className={`max-w-4xl mx-auto transition-all duration-1000 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          ...
          {/* Our Team Section */}
          <div className={`glass rounded-2xl p-8 mb-12 transition-all duration-700 delay-400 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <div className="text-center">
              <Link href="/team" className="inline-flex items-center glass px-6 py-3 rounded-lg hover:bg-white/10 transition-all duration-300 text-white">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
            ...
            <div className={`text-center sm:col-span-2 lg:col-span-1 transition-all duration-700 delay-300 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              <div className="glass rounded-2xl p-8 h-full">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mt-12">
            <Link href="/publications" className="glass px-6 py-3 rounded-lg hover:bg-white/10 transition-all duration-300 text-white text-center">
              View Publications
            </Link>
            <Link href="/" className="px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg hover:from-blue-600 hover:to-purple-700 transition-all duration-300 text-white text-center">
              Back to Home
            </Link>
          </div>
        </div>

            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center items-center relative p-8">
              ...
              <div className="w-full h-48 lg:h-64 rounded-xl gradient-border inner-glow overflow-hidden relative mb-6">
                ...
                <div className="absolute" style={{ top: '50%', left: '50%', transform: 'translate(-50%, -50%)' }}>
                  <div className="w-16 h-16 flex items-center justify-center inner-glow border border-blue-400/50 rounded-2xl animate-schema-pulse" style={{ backgroundColor: 'rgba(0, 0, 0, 0.20)', backdropFilter: 'blur(10px)' }}>
